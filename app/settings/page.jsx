          ...
          <div className="px-6 py-4">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-md border">{escapeHtml(user?.name || "N/A")}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-md border">{escapeHtml(user?.email || "N/A")}</p>
              </div>
            </div>
          </div>
        </div>
